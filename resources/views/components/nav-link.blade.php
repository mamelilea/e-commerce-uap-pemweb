...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-[#ff9900] text-sm font-medium leading-5 text-[#ff9900] focus:outline-none focus:border-[#ff9900] transition duration-150 ease-in-out'
