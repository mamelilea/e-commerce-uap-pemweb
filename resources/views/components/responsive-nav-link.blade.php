...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-[#ff9900] text-start text-base font-medium text-[#ff9900] bg-gray-800 focus:outline-none focus:text-[#ff9900] focus:bg-gray-800 focus:border-[#ff9900] transition duration-150 ease-in-out'
