...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 gap-4">
        <div>
            ...
            <p class="text-gray-500 mt-2">Update details for {{ $category->name }}.</p>
        </div>
    </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name', $category->name) }}" class="w-full rounded-xl border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-k-pink/20 focus:border-k-pink transition-all py-3 px-4" required>
                            @error('name')
                        ...
                        <div>
                            ...
                            <input type="text" name="tagline" value="{{ old('tagline', $category->tagline) }}" class="w-full rounded-xl border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-k-pink/20 focus:border-k-pink transition-all py-3 px-4">
                            @error('tagline')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="5" class="w-full rounded-xl border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-k-pink/20 focus:border-k-pink transition-all py-3 px-4" required>{{ old('description', $category->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
