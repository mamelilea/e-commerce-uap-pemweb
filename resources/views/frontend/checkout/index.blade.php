                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 mb-8">
                    ...
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" name="name" value="{{ auth()->user()->name }}" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-k-pink focus:ring-k-pink">
                        </div>

                        <div class="sm:col-span-2">
                            <label class="block text-sm font-medium text-gray-700">Address</label>
                            <input type="text" name="address" value="{{ auth()->user()->address ?? '' }}" placeholder="Street address, P.O. Box..." class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-k-pink focus:ring-k-pink">
                        </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <label class="cursor-pointer">
                            ...
                            <div class="p-4 border rounded-xl peer-checked:border-k-pink peer-checked:bg-pink-50 hover:bg-gray-50 transition-all text-center">
                                ...
                                <div class="text-xs text-gray-500 mt-1">Rp {{ number_format(auth()->user()->balances->balance ?? 0, 0, ',', '.') }}</div>
                            </div>
                        </label>
                        <label class="cursor-pointer">
        ...
        <div class="lg:col-span-5">
            <div class="bg-gray-50 rounded-2xl p-8 sticky top-24">
                ...
                <div class="flex gap-4 mb-6 pb-6 border-b border-gray-200">
                    <div class="w-20 h-20 bg-white rounded-lg overflow-hidden border border-gray-200">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">Qty: {{ $quantity }}</p>
                    </div>
                    <div class="ml-auto font-bold text-gray-900">
                ...
                <div class="space-y-3 mb-6 pb-6 border-b border-gray-200">
                    <div class="flex justify-between text-sm">
                        ...
                        <span class="font-medium text-gray-900">Rp {{ number_format($product->price * $quantity, 0, ',', '.') }}</span>
                    </div>
                    <div class="flex justify-between text-sm">
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <span class="text-2xl font-bold text-k-pink">Rp {{ number_format(($product->price * $quantity) + 16000, 0, ',', '.') }}</span>
                </div>
            </div>
        </div>
    </div>
