...
![Struktur Database](public/db_structure.png)
...
_(Atau `copy .env.example .env` jika menggunakan Command Prompt Windows)_
...
_Tips: Gunakan opsi ini jika Anda ingin langsung melihat tampilan aplikasi yang terisi penuh._
...
_(Atau gunakan `npm run dev` jika ingin mode live-reload, lihat bagian "Menjalankan Aplikasi")_
...
| **Seller** | seller@freshmart.com | password123 |
| **Member** | buyer@freshmart.com  | password123 |
